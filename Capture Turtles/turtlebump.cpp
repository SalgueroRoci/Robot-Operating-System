...
int main(int argc, char **argv)
{
	...
	// Create turtles 
	system("rosservice call /kill turtle1");	// kill the default turtle
...
void create_mainturtle(ros::ServiceClient addt) {
	//system("rosservice call /kill turtle1"); // MOVED to moveAI()
	srv.request.x = 0;
	srv.request.y = 0;
	srv.request.theta = 0;
